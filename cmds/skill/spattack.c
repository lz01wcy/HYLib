...
void do_remote_fight(object me, object couple, object target, int n)
{
	...
	if (me->is_busy())
        ...
        me->add_temp("apply/damage", enhance);
...
void do_here_fight(object me, object couple, object target, int n)
{
	...
	if (me->is_busy())
        ...
        me->add_temp("apply/damage", enhance1);
        couple->add_temp("apply/damage", enhance2);
...
支持，当然这需要耗费内力，两个人灵肉结合的次数越多，耗费的内
力就越少。如果你的伴侣就在你的身边，则可以一起施展招数攻击对
手，不需要耗费内力，招数的威力与两的人灵肉结合的次数于伴侣的
内功等级相关。
HELP );
        return 1;
}
