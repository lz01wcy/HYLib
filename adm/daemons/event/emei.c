...
private void do_bonus(object room) {
    ...
    if (r == 0) {
        ...
        NOR;
        msg += HIR
        "只见太阳一点一点的升了起来，倏的眼前一亮，一道光晕出现在云际，\n"
        "朦朦胧胧似乎有一个佛影立在当中，令人叹羡不已。\n"
        NOR;
        msg += HIG
        "你冥冥中仿佛得到了佛主的指示，登时有茅塞顿开的感觉。\n"
        NOR;
        ...
        NOR;
        msg += HIG
        "在峨嵋山上欣赏日出令人心旷神怡，格外领略峨嵋山的隽秀险奇。\n"
        NOR;

        switch (random(3)) {
            case 0:
                msg += HIY
                "一轮红日跃出天际，映射得层峦叠翠分外妖娆，茫茫云海，尽披红妆。\n"
                NOR;
                break;
            case 1:
                msg += HIY
                "忽然间一轮红日跃了上来，天地之间登时辉煌无比，只射得你眼睛都无法睁开。\n"
                NOR;
                break;
            default:
                msg += HIY
        ...
        switch (random(3)) {
            case 0:
                msg = WHT
                "眼见太阳朦朦胧胧的就要升上来，却见一片乌云飘过，遮了个严严实实。\n"
                NOR;
                break;
            case 1:
                msg = WHT
                "你眼前越来越亮，但是雾气好重，让你什么都看不清楚。\n"
                NOR;
                break;
            default:
                msg = WHT
                "天边渐渐的发白，但是一层一层的云气将日头压得光芒一丝都看不见。\n"
                NOR;
                break;
        }
        msg += HIG
