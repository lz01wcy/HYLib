...
private void do_bonus(object room) {
    ...
    if (r == 0) {
        ...
        NOR;
        msg += HIC
        "只听天空骤然传来一阵刺耳的摩擦声，你仰望上苍，发现穹苍里已豁然出现\n"
        ...
        msg += HIG
        "你仔细的观察了流星雨的全过程，发现其中竟有很多奥秘可以融于武学。\n"
        NOR;
        ...
        NOR;
        msg += HIC
        "只听远处一阵刺耳的摩擦声，举目望去，发现竟有流星从天边划过，怎奈距\n"
        "隔委实太远，根本无法看清。\n"
        NOR;
        ...
        switch (random(2)) {
            case 0:
                msg = WHT
                "眼见天边一片明亮，知是流星雨将至，可怎奈间隔遥且云层厚，却无缘得见。\n"
                NOR;
                break;
            default:
                msg = WHT
                "眼见天边一片明亮，但是水气，雾气和云层交杂，让你什么都看不清楚。\n"
                NOR;
                break;
        }
        msg += HIG
