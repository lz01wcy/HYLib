...
private void do_bonus(object room) {
    ...
    if (r == 0) {
        ...
        NOR;
        msg += HIG
        "只听轰隆隆声音大做，振聋发聩，令人心惧神摇！你抬头看去，只见\n"
        "黄昏中水帘洞笼罩在层层雾气之中，分外妖娆。洞外水流飞泻，气势惊人！\n"
        NOR;
        msg += HIG
        "你望着湍急的瀑布飞练，为这世间美景惊叹不已，从"
        "中不禁领悟到了武学的道理。\n"
        NOR;
        ...
        "【谣言】" + "听说衡山水帘洞瀑布激流澎湃，奇景非凡，无数游人叹羡不已。\n"
        NOR, users());
        ...
        NOR;
        msg += HIY
        "一阵轰隆轰隆的声音传来，你抬头一看，只见黄昏中瀑布腾起层层雾气。\n"
        NOR;
        switch (random(3)) {
            case 0:
                msg += HIY
                "看着这壮丽的瀑流，你不禁感叹，正所谓「飞流直"
                "下三千尺，疑是银河落九天」啊。\n"
                NOR;
                break;
            case 1:
                msg += HIY
                "瀑流就像一席倒挂的白帘，气势如虹，天地都不禁为之失色。\n"
                NOR;
                break;
            default:
