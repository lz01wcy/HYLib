...
int do_full_flower()
{
	...
	tell_room(environment(), "\n几个花匠走了进来。\n");
	 tell_room(environment(), "“嗨！阿珂，给你送鲜花来了。”带头的那个花匠对阿珂打招呼。\n");
	 tell_room(environment(), "“阿珂喜声道：“谢谢花匠叔叔，放在后面的花室里吧。”\n");
 	 tell_room(environment(), "花匠们走过去将花放置好。\n");
	 tell_room(environment(), "花匠们走了出来对阿珂说道：“花放好了，我们下次再来。”\n");
...
int ask_songhua()
{
        write("阿珂欠身说到：“感谢客官光临小店，您先在这里将花买好，\n"
			  "然后告诉小女要送给谁，小女一定为您送到。\n"
