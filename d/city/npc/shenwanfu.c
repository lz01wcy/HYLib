...
面同样闪动着一丝狡黠的光芒。他就是这家白衣铺的老板。\n");
	...
	set("vendor_goods", ({
		__DIR__"cloth/baiduanshan",
		__DIR__"cloth/baizhusipao",
		__DIR__"cloth/commcloth",
		__DIR__"cloth/hulannaao",
		__DIR__"cloth/mabukuanshan",
		__DIR__"cloth/shabuzhizhui",
		__DIR__"cloth/zhifengkuanshan",
		__DIR__"cloth/nenlvchoushan", 
		__DIR__"cloth/danhuangshayi",
		__DIR__"cloth/yinhongshanzi",
		__DIR__"cloth/sahuaao",
	}) );
