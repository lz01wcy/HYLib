...
int do_bump(string arg){
        ...
        if (this_player()->query("neili")>1000 ){
                ...
                this_player()->add("eff_qi",-(int)(this_player()->query("max_qi")/5));
                this_player()->add("jing",-(int)(this_player()->query("max_qi")/5));
                ...
                this_player()->add("eff_qi",-(int)(this_player()->query("max_qi")*4/5));
                this_player()->add("jing",-(int)(this_player()->query("max_qi")*4/5));
                this_player()->set("force",0);
        }
        return 1;
}     
