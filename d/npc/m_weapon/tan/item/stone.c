...
int do_eat(string stone) {
    ...
    switch (n) {
        case 0:
            message_vision(HIY
            "$N看来急坏了，拿起补天石就啃，结果当场大牙蹦掉了十二颗!这也算冶炼？真傻！\n"
            NOR, me);
            me->add("food", 200);
            me->add("water", 200);
            break;
