...
void create()
{
		  ...
		  set_skill("luoyan-jian", 340);
		  set_skill("hengshan-jian", 340);
		  set_skill("songshan-jian", 340);
		  set_skill("shiba-pan", 340);
		  set_skill("duanjia-sword", 340);

		  set_skill("taiji-jian", 340);
		  set_skill("huashan-sword", 340);
		  set_skill("damo-jian", 340);
		  set_skill("huifeng-jian", 340);
		  set_skill("duanjia-sword", 340);
		  set_skill("pixie-jian", 340);
		  set_skill("taiji-shengong", 340);
		  set_skill("kuihua-xinfa", 340);
