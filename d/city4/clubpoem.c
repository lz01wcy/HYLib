...
{ 
    ...
    if(me->query_temp("poemok")>50)
      return notify_fail("你休息一下，让别人来回答吧!\n");
...
if (me->query("combat_exp")<1000000)
{
             ...
             write("你的潜能增加了！\n");
	     break;
     case 2: lite=8+random(33);
if (me->query("combat_exp")<1000000)
{
             me->improve_skill("literate",lite);
}
else {
             me->improve_skill("literate",lite/3);
}
             me->add("jing",-me->query("eff_jing")/20);
             me->add("eff_jing",-me->query("max_jing")/20);
	     write("你的读书识字进步了！\n");
