...
"因欺师灭祖被逐出师门的全真高手。\n");
  ...
  set("max_qi",8500+random(2000));
  set("max_jing",8500+random(2000));
  set("max_sen",8500+random(2000));
  set("max_neili",8500+random(2000));
  set("max_mana",8500+random(2000));
  set("eff_neili",8500+random(2000));
