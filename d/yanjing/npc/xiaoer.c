...
tell_object(ob,HIY"店小二笑咪咪地说道：这位"+RANK_D->query_respect(ob)+"，欢迎来到"GRN"海洋II。"HIY"
...
那里。
    如果您对这个游戏的设计和管理有什么建议或意见，请到情义盟的
主页"HIC"http://lywin.126.com留言"HIY"，我们一定会认真考虑的。\n\n"NOR);
...
int accept_object(object who, object ob)
{
	...
	{
		tell_object(who, "小二一哈腰，说道：多谢您老，客官请里面歇息。\n");
