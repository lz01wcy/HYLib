...
int do_xunchen()
{
        ...
        if ( me->query_temp("xunchen"))
        {
               ...
               {
                      message_vision("$N对着$n说：你东城门楼没去看看？这算巡的什么城？\n", this_object(), me);
                      return 1;
               }
               if (!me->query_temp("xuncheng/nupgate"))
               {
                      message_vision("$N对着$n说：你北城门楼没去看看？这算巡的什么城？\n", this_object(), me);
                      return 1;
               }
               if (!me->query_temp("xuncheng/supgate"))
               {
                      message_vision("$N对着$n说：你南城门楼没去看看？这算巡的什么城？\n", this_object(), me);
                      return 1;
               }
               if (!me->query_temp("xuncheng/wupgate"))
               {
                      message_vision("$N对着$n说：你怎么没去西城门楼？这算巡的什么城？\n", this_object(), me);
                      return 1;
               }
