...
//	command("drop "+(string)dest->query("id"));
	...
	{
	case 0 :
		me->move("/d/city/guangchang"); // 扬州
		break;
	case 1 :
		me->move("/d/changan/guangchang"); // 长安
		break;
	case 2 :
		me->move("/d/jingzhou/guangchang"); // 荆州
		break;
	case 3 :
		me->move("/d/chengdu/guangchang"); // 成都
		break;
	case 4 :
		me->move("/d/kunming/jinrilou"); // 昆明
		break;
	case 5 :
		me->move("/d/beijing/xichang1"); // 北京
		break;
	}
