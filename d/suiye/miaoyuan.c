...
int do_peiyu()
{
        ...
        if (me->query("combat_exp") > 880000 && !wizardp(me))
        {
...
int do_jiaoshui()
{
        ...
        if (me->query_temp("peiyu") == 2)
        {
                if (random(10) < 3)
                {
                        switch (random(8))
                        {
                                case 1 : ob = new(__DIR__"npc/obj/hmeigui"); break;
                                case 2 : ob = new(__DIR__"npc/obj/zi-luolan"); break;
                                case 3 : ob = new(__DIR__"npc/obj/bai-chahua"); break;
                                case 4 : ob = new(__DIR__"npc/obj/hong-meigui"); break;
                                case 5 : ob = new(__DIR__"npc/obj/baihua"); break;
                                case 6 : ob = new(__DIR__"npc/obj/hua"); break;
                                case 6 : ob = new(__DIR__"npc/obj/hua3"); break;
                                case 0 : ob = new(__DIR__"npc/obj/lan-tiane"); break;
                        }
