...
void create()
{
	...
	set_skill("blade", 100);
	set_skill("whip", 190);
	set_skill("yunlong-shengong", 90);
	set_skill("yunlong-shenfa", 90);
	set_skill("wuhu-duanmendao", 290);
	set_skill("houquan", 190);
	set_skill("yunlong-jian", 190);
	set_skill("yunlong-bian", 190);
