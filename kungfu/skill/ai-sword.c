...
//1
    ...
    "$N已挐了$w"
    HIW
    "在手，剑如流水，见风就长，剑美，剑法更美，美的像一个受宠若惊，\n"
    + HIW
    "那一剑不是勾魂，也不是夺魄，而是一种魂尽天涯无飘泊，转成了电的速度，雷的震愕，向$n"
    HIW
    "刺来！"
    NOR,
            "dodge"  :        115,
...
//2
    ...
    "$w"
    HIW
    "迎着冷月闪出爱情一般奇诡的冷芒，在冷月下浮沉了几道寒芒，就像凄美得可以让人\n"
    + HIW
    "一口逼进的鲸吞，有如剑花般的寂莫，缭绕在$n"
    HIW
    "脑里，迂回在$n"
    HIW
    "心中，直攻入愁肠！"
...
//3
    ...
    "$N心静，手稳，闷哼一声，手中$w"
    HIW
    "已刺出点点银光，像一记无意的顾盼，刻意的雷极，\n"
    + HIW
    "直击$n，剑影如深深的恨，浅浅的梦，又似岁月的泪\痕！"
    NOR,
            "dodge"  :        130,
            "parry"   :          630,
            "damage" :        680,
...
//4
    ...
    NOR +
    HIW
    "$N这一剑的意境，无法用言语、用图画、用文字去形容，既不是快、亦不是奇、也不是绝、更不只是优美，\n"
    + HIW
    "而是一种只应天上有，不应世间无的剑法，$n"
    HIW
    "惊愣的脸容在刹那间凝结！"
    NOR,
            "dodge"  :         130,
...
//5
    ...
    NOR +
    HIW
    "$N啸声清亮，如鹰戾九宵，剑影交错似如漩涡，又似湖中的涟漪，绵绵不绝，那银芒就宛如夜星般的\n"
    + HIW
    "令$n"
    HIW
    "不知该如何闪避，刹那间溅起了淡淡血光！"
...
//6
    ...
    "$N手中的$w"
    HIW
    "发出一道淡淡的蓝光，淡的就像是黎明初现的那一抹曙色，来势奇快，无影无形，\n"
    + HIW
    "剑气激荡，凌厉无比，令$n"
    HIW
    "难以抵挡，剑气的锋芒砍入肌骨！"
...
//7
    ...
    NOR +
    HIW
    "沧凉古老的剑声，就仿佛和晨雾从虚无缥缈中散发出来的，缥缈的剑声，像是远方伊人的呼唤，\n"
    + HIW
    "又像是在诉说一种说不出的哀愁，无可奈何的哀愁，却又带着说不出的宁静！"
    NOR,
            "dodge"  :        150,
            "parry"   :        150,
            "damage" :        600,
...
//8
    ...
    "凄美的剑光让$n"
    HIW
    "心神纠缠化成郁结，不哭一声，不诉一声，就把$n"
    HIW
    "的记忆导引向要忘了的那一段浮沉，\n"
    + HIW
    "把白昼换上黄昏的寂寞，让$n"
    HIW
    "逐渐失去自己的感觉，而在岁月的微光里平添害怕，而且不甚快乐！"
    NOR,
            "dodge"  :          150,
            "parry"   :          150,
            "damage" :        650,
...
void two(object me, object victim, object weapon, int damage) {
    ...
    if (bell < 100
        ...
        HIW
        "                          美丽．光华在闪动．变幻．高高在上．轻云飘忽\n\n"
        HIW
        "                   $n只觉得这道光华仿佛就在自己眉宇间，又仿佛在虚无缥缈间\n\n"
        HIW
        "                   它的变化，几乎已超越了人类能力的极限，几乎已令人无法相信\n\n"
        NOR, me, victim);
        for (i = 0; i <= mk1; i++) {
...
int five_kill(object me, object victim, object weapon, int damage) {
    ...
    message_vision("\n
                   "HIY"
    $N的人与剑已开始有了动作，一种极缓慢，极优美的动作，就像是风那么自然\n
    "HIY"
    $N的瞳孔在收缩，"+weapon->name()+""HIY"
    已慢慢的刺了出来\n
    "HIY"
    从最不可思议的部位刺了出来，刺出时忽然又有了最不可思议的变化\n
    "HIY"
    世上根本没有人能破这一剑，绝对没有任何人能谁想去破这一剑，就是去送死\n\n
    "NOR,me,victim);
    if (random(2) == 0) {

        message_vision(HIR
        "              血花耀眼又灿烂，灿烂的婉如流星，流星一现即逝，血花也很快的洒下\n"
        NOR, me);
        ...
        if (env == environment(victim)) {
            ...
            switch (random(4) + 1) {
                case 1 :
                    ...
                    "这么空虚的一剑，不但是刺向$n，还似忘情过去，刺向未来，而且还刺至虚无的任一处．． \n"
                    NOR),me, victim);
                    break;
                case 2 :
                    message_vision(sprintf("\n                               "
                    ...
                    NOR),me, victim);
                    message_vision(sprintf(HIW
                    "半空剑光化作电光，霹雳击下，剑意切入了$n中，卷入了剑气，剑光一闪而殁\．． \n"
                    NOR),me, victim);
                    break;
                case 3 :
                    message_vision(sprintf("\n                               "
                    ...
                    NOR),me, victim);
                    message_vision(sprintf(HIW
                    "一片紫色剑光仿若海浪般卷向$n，$n眼里没有痛苦，没有悔意，甚至没有一点表情．．\n"
                    NOR),me, victim);
                    break;
                case 4 :
                    message_vision(sprintf("\n                               "
                    ...
                    NOR),me, victim);
                    message_vision(sprintf(HIW
                    "这一剑之势令$n无法闪躲，就像命宫里的一颗魔星，八字里注定了那么一剑拦在命运里．．\n"
                    NOR),me, victim);
                    break;
            }
            COMBAT_D->report_status(victim);
...
void seven(object me, object victim, object weapon, int damage) {
    ...
    if (random(2) == 0) {
        ...
        "\n      $N手中握的" + weapon->name() + ""
        HIW
        "仿佛是杀人的利器，精华，致命的一招，这一招不但诡异．毒辣．准确\n\n"
        HIW
        "        $n所有的动作，竟在这一剑使出时忽然间全部停顿，然后苍穹间就溅出了一片花雨\n\n"
        HIW
        "                    满天的剑影，满天的血花，剑花又转，由慢转快，由纯变混\n\n"
        HIW
        "               忽然又化作一道匹练般的彩红，七色彩红，七剑，多采多姿，千变万化\n\n"
        NOR, me, victim);
        for (i = 1; i <= 7; i++) {
            switch (i) {
                case 1:
                    message_vision(sprintf(HIR
                    "                       --<<红>>剑意有如风不定．伤遮流景．落红应满径--\n"
                    NOR),me, victim);
                    break;
                case 2:
                    message_vision(sprintf(YEL
                    "                       --<<橙>>剑意有如抛弃久．惆怅依旧．镜里人颜瘦--\n"
                    NOR),me, victim);
                    break;
                case 3:
                    message_vision(sprintf(HIY
                    "                       --<<黄>>剑意有如雨初歇．晓风残月．更与何人说--\n"
                    NOR),me, victim);
                    break;
                case 4:
                    message_vision(sprintf(HIG
                    "                       --<<绿>>剑意有如黯天际．望极春愁．强乐还无味--\n"
                    NOR),me, victim);
                    break;
                case 5:
                    message_vision(sprintf(HIB
                    "                       --<<蓝>>剑意有如乱蝉嘶．酒徒萧索．不似去年时--\n"
                    NOR),me, victim);
                    break;
                case 6:
                    message_vision(sprintf(CYN
                    "                       --<<靛>>剑意有如照无眠．悲欢离合．何似在人间--\n"
                    NOR),me, victim);
                    break;
                case 7:
                    message_vision(sprintf(MAG
                    "                       --<<紫>>剑意有如追忆思．酒入愁肠．化作相思泪\--\n"
                    NOR),me, victim);
                    break;
            }
            if (sk > random(30) + 100) {
                message_vision(sprintf(HIC
                "$n被$N的七色剑意所困，全身上下伤痕累累！\n"
                NOR),me, victim);
                victim->receive_wound("qi", da + random(3000));
                COMBAT_D->report_status(victim, 1);
            } else {
                message_vision(sprintf(WHT
                "$n" + WHT
                "心如止水，看清了$N" + WHT
                "的剑势！\n"
                NOR),me, victim);
...
void dream(object me, object victim, object weapon, int damage) {
    ...
    if (random(2) == 0) {
        if (random(100) > 50) {
            ...
            "HIW"
            天地间飘曳起一道幽幽蓝光，似真似幻，如沉静的月光投入深邃的大海 \n
            "HIW"
            这一剑，极快、极速、极简单、看去极平凡无奇．．． \n
            "HIW"
            然而却是“相思碎梦”一千零一式中所有的精华和杀招！\n
            "HIW"‘"HIR"
            舞剑．卷尘．风行斩
            "HIW"’ \n\n
            "NOR, me);
            ...
            "HIW"
            血红般的剑气有如太阳西下般撩绕在$n的周围\n
            "HIW"
            $n只觉得又快、又奇、又绝、惊艳、潇洒、惆怅、不可一世\n
            "HIW"‘"HIC"
            烽火红尘路
            "HIW"’\n
            "NOR,me,victim);
    ...
    for (i = 1; i <= 8; i++) {
        switch (i) {
            case 1:
                ...
                "忘弃红尘"
                HIW
                "之" + NOR + "" + RED + "「伤心律”" + NOR + "" + HIY + "，剑势如乱麻般攻向$n！\n"
                NOR),me, victim);
                break;
            case 2:
                message_vision(sprintf(HIY
                ...
                "忘弃红尘"
                HIW
                "之" + NOR + "" + GRN + "「扣心弦”" + NOR + "" + HIY + "，剑势如惋伤般紧扣$n！\n"
                NOR),me, victim);
                break;
            case 3:
                message_vision(sprintf(HIY
            ...
            case 5:
                ...
                "忘弃红尘"
                HIW
                "之" + NOR + "" + CYN + "「惑心音”" + NOR + "" + HIY + "，剑势如鬼魅般迷惑$n！\n"
                NOR),me, victim);
                break;
            case 6:
                message_vision(sprintf(HIY
            ...
            case 8:
                ...
                "之"
                HIW
                "「定心调”" + NOR + "" + HIY + "，剑势如无形般直取$n。\n"
                NOR),me, victim);
                break;
        }
        if (me->query_skill("ai-sword", 1) > random(60) + 100) {
            message_vision(sprintf(MAG
            "结果被$N确确实实的命中要害，$n身上立即多了一道无情的伤痕！\n"
            NOR),me, victim);
        ...
        for (i = 1; i <= 3; i++) {
            switch (i) {
                ...
                case 2:
                    ...
                    NOR, me, victim);
                    message_vision(HIW
                    "剑光绰约，腾起一阵凌厉而且艳丽的杀意，剑气如浪分涛裂似排山倒海的击出，\n" +
                ...
                case 3:
                    ...
                    NOR, me, victim);
                    message_vision(HIW
                    "天雷忽起，大地浮沉，剑光摒出一道道的强光，裂苍天而出，震苍生而鸣，狂飙忽起，\n" +
...
//        int me_jing = me->query("max_jing")/5;
    ...
    if (!me->query_temp("disenforce")) {
        if (skillb >= 100 && random(2) == 0) {
            ...
            HIR
            "              剑势本来很快，就在这时忽然慢了下来，很慢，虽然慢，却还是在变\n\n"
            HIR
            "                        光芒在现，剑锋迥异，剑光如幻，诡异的闪动\n\n"
            HIR
            "                $n觉得这份诡异仿佛就在自己眉睫间，又仿佛在虚无的缥缈间\n\n"
            NOR
            "            "
            HBBLU
            "剑光剑意已侵入$n神志，粉碎了$n的斗志，让$n尽往回忆的伤悲处走\n"
            NOR, me, victim);
...
int valid_learn(object me) {
    ...
    if (me->query("get-2skill-s") != 1)         //解ai-sword的mark
    {
        ...
        if (bell > 100) {
            tell_object(me, HIY
            "小人物说道：你心存杀念, 怎么能够学习情剑呢！\n");
            return 0;
        }
        tell_object(me, HIY
        "小人物说道：学此剑法需扣潜能、精、气各五点。\n");
        me->add("jing", -5);
        me->add("qi", -5);
//        me->add("sen", -5);
        me->add("potential", -5);
