...
string *action_msg = ({
    "$N轻抚手中的$w，突然间只见刀光一闪，" + (order[random(13)]) + "「再闪，又一闪」"
    NOR
    "！三道刺骨的寒气已然袭上了$n的$l",
            "只见$N倒提$w，" + (order[random(13)]) + "「身形急冲」"
    NOR
    "，就在与$n错身之际，突然反手一刀从$n后脑斜劈而下",
            "$N斜身飞起，带出一片匹练也似的" + (order[random(13)]) + "「刀光」"
    NOR
    "卷向$n的$l",
            "$N突然一脚踢出，手中的$w划出一道" + (order[random(13)]) + "「轻妙的圆弧」"
    NOR
    "，淡淡的刀光封住了$n的头脸，切断了$n的呼吸",
            "只见$N脸色一寒，一招" + (order[random(13)]) + "「千里冰封」"
    NOR
    "使出，从眉捷到脚跟，\n$n周身的血液都似被这无尽的刀势冻住，而生命也仿佛要离体而去",
            "$N刀势渐慢，而$w上带出的寒气却越来越浓。就在这时，\n$n的心头一紧，" + (order[random(13)]) + "「一道比针尖还要锐利的寒气」"
    NOR
    "已刺上了$n$l",
            "$N也不管三七二十一，高举$w呼！地就是一刀向$n" + (order[random(13)]) + "「迎面斩下！」"
    NOR
