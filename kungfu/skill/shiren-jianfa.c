...
mapping *action = ({
    ...
    ([    "action":        "$N手中的$w迎风一晃，刀锋带出裂锦般的声音，一招" + (order[random(13)]) + "「袈裟斩」"
    NOR
    "万马奔腾般地砍向$n的$l",
            "force":        100,
            "damage":               100,
    ...
    ([    "action":        "$N手中的$w迎风狂舞，一招" + (order[random(13)]) + "「逆袈裟」"
    NOR
    "象暴风中的滚沙，裹向$n的$l",
            "damage":               120,
            "force":        120,
    ...
    ([    "action":        "$N手中的$w象狂风中的流云，正是" + (order[random(13)]) + "「左切上」"
    NOR
    "忽聚忽散地砍向$n的$l",
            "force":        100,
            "damage":               200,
    ...
    ([    "action":        "$N手中的$w象狂风中的流云，正是" + (order[random(13)]) + "「右切上」"
    NOR
    "忽聚忽散地砍向$n的$l",
            "force":        100,
            "damage":               200,
    ...
    ([    "action":        "$N晃动手中的$w，突然使出了" + (order[random(13)]) + "「刺突剑」"
    NOR
    "刀光忽隐忽现，象秋风中的落叶，一刀连一刀地散向$n的$l",
            "force":        200,
            "damage":               200,
            "dodge" : 130,
            "lvl" : 80,
    ...
    ([    "action":        "$N聚起全身的功力，" + (order[random(13)]) + "「逆风」"
    NOR
    "手中的$w象刺骨寒风般割向$n",
            "force":        240,
            "damage":        240,
    ...
    ([  "action" : "$N纵身跃起手中$w轻挥，一式" + (order[random(13)]) + "「居合拔斩」"
    NOR
    "斩向$n后颈",
            "damage" : 250,
            "dodge"  : 140,
    ...
    ([  "action" : "$N高高跃起，手中$w连话三个弧形，使出" + (order[random(13)]) + "「翔尾闪」"
    NOR
    "向$n的右臂齐肩斩落",
            "damage" : 280,
            "dodge" : 140,
    ...
    ([  "action" : "$N轻吁一声，使出" + (order[random(13)]) + "「真直斩」"
    NOR
    "，刷刷刷刷四刀，向$n胸，腹，腰，肩四处连刺",
            "damage" : 300,
            "dodge" : 145,
            "force" : 205,
            "lvl"   : 140,
    ...
    ([  "action" : "$N仰天一声清啸，一招" + (order[random(13)]) + "「踏入垂直斩」"
    NOR
    "，斜行向前，$w横削直击，迅捷无比，击向$n的$l",
            "damage" : 350,
            "dodge" : 145,
            "force" : 205,
            "lvl"   : 160,
    ...
    ([      "action":"$N施展出了" + (order[random(13)]) + "「疾空杀」"
    NOR
    "绕着$n飞旋，$w带着狂野刀风，凌历无比地劈出六刀",
            "force" : 220,
            "dodge" : 130,
            "damage": 400,
            "lvl" : 200,
    ...
    ([      "action":"$N一着" + (order[random(13)]) + "「左滑回转斩」"
    NOR
    "，突然抢进$n近侧，迅猛地驱刀连斩，攻式顿然合成一个圆圈",
            "force" : 230,
            "dodge" : 130,
            "damage": 420,
            "lvl" : 225,
    ...
    ([      "action":"$N大喝一声，手中$w大开大阖，连连挥刀使出" + (order[random(13)]) + "「右滑回转斩」"
    NOR
    "，斩向$n的$l",
            "force" : 230,
            "dodge" : 130,
    ...
    ([      "action":"$N运刀如风，连续用出了" + (order[random(13)]) + "「疾空杀」"
    NOR
    "，" + (order[random(13)]) + "「虚空杀」"
    NOR
    "，" + (order[random(13)]) + "「百鬼杀」"
...
mapping query_action(object me, object weapon) {
    ...
    if (!userp(me) || (int) me->query_skill("shayi-xinfa", 1) > 10) {
        ...
        if (random(8) == 1 && random(level) > 150) {
            ...
            "action" : HIR
            "「火产灵神!」" + HIY
            "$N把整把无限刃由刀身至刀尖燃烧,能力发挥至极限,完全焚毁对手!!"
            NOR,
                    "force" : 850,
                    "dodge" : 150,
                    "damage": 850,
        ...
        if (random(8) == 1 && random(level) > 150) {
            ...
            "action" : HIG
            "「影子着鬼附身!」" + HIY
            "$N将心之一方作用于自己,使自己相信本身天下无敌,引发所有潜能,发挥最强威力。 "
            NOR,
                    "force" : 850,
                    "dodge" : 150,
                    "damage": 850,
        ...
        if (random(8) == 1 && random(level) > 150) {
            ...
            "action" : HIC
            "「背车刀!」" + HIY
            "$N将右手的刀于背后交给左手,利用假动作，在预料不到的地方出刀 。 "
            NOR,
                    "force" : 850,
                    "dodge" : 150,
                    "damage": 850,
        ...
        if (random(8) == 1 && random(level) > 250) {
            ...
            "action" : HIW
            "「二阶堂平法!」" + HIY
            "$N由[一,八,十]这三字组成[平]字将剑气射出,麻痹心肺$n,并让$n无法动弹。 "
            NOR,
                    "force" : 650,
                    "dodge" : 150,
                    "damage": 650,
...
mixed hit_ob(object me, object victim, int damage_bonus, int factor, string limb) {
    ...
    if (damage_bonus > 100 && random(level2) > 150) {
        ...
        return RED
        "只见$n$l上鲜血狂奔，已被" + weapon->name() + HIR
        "斩出的无形气劲切了开来!\n"
        NOR;
    }
}
...
int ob_hit(object ob, object me, int damage) {
    ...
    if (random(level) > 150
        ...
        if (random(3) == 0 && ob->query("qi") > 50
            ...
            msg = HIR
            "「 瞬天杀! 」。$N使出超神速的缩地加天剑拔刀术，在$n未感痛楚前想置其死地!!。\n"
            NOR;
            if (!ob->is_busy())
                ob->start_busy(3);
            ...
            msg += damage_msg(damage, "瘀伤");
                   ...
                   && ob->query("eff_jing") > 50) {
            msg = HIR
            "「火产灵神!」。$N把整把无限刃由刀身至刀尖燃烧,能力发挥至极限,完全焚毁$n!!\n"
            NOR;
            if (!ob->is_busy())
                ob->start_busy(3);
            if ((int) ob->query("qi") < 60000) {
                ...
                msg += damage_msg(damage, "瘀伤");
                   ...
                   && ob->query("eff_jing") > 50) {
            msg = HIR
            "「回天剑舞六连!」。$N反握小太刀,运用流水招式刺出,左右再变两招,瞬间出六招!! \n"
            NOR;
            if (!ob->is_busy())
                ob->start_busy(3);
            if ((int) ob->query("qi") < 60000) {
