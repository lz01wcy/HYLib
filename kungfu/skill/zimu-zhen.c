...
mapping *action = ({
    ([    "action":        "$N双手连环挥舞，一招" + (order[random(13)]) + "「穿心针」"
    NOR
    "，$w直奔$n的胸腹要害",
            "dodge":        100,
            "force":        200,
    ...
    ([    "action":        "$N身形晃动，一招" + (order[random(13)]) + "「破气针」"
    NOR
    "，手中$w如一串银线，往$n咽喉打去",
            "dodge":        20,
            "force":        200,
    ...
    ([    "action":        "$N五指微张，一招" + (order[random(13)]) + "「吸血针」"
    NOR
    "，手中$w飞蚊般往$n全身叮去",
            "dodge":        40,
            "force":        200,
    ...
    ([    "action":        "$N大喝一声，一招" + (order[random(13)]) + "「摄魂针」"
    NOR
    "，$w幻化出夺目光亮，打向$n",
            "dodge":        50,
            "force":        200,
    ...
    ([    "action":        "$N错步一跃，一招" + (order[random(13)]) + "「夺魄针」"
    NOR
    "，$w带着阵阵阴风，打向$n全身",
            "dodge":        60,
            "force":        200,
    ...
    ([    "action":        "$N双目精芒闪动，一招" + (order[random(13)]) + "「离别针」"
    NOR
    "，手中$w全数脱手飞出，排山倒海般打向$n全身",
            "dodge":        50,
            "force":        200,
            "damage":        550,
            "poison": 80,
    ...
    ([    "action":        "$N纵声长啸，一招" + (order[random(13)]) + "「天魔针」"
    NOR
    "，$w竟然带着一股强烈劲风，扫向$n",
            "dodge":        70,
            "force":        200,
    ...
    ([    "action":        "$N眼中杀气突然大盛，一招" + (order[random(13)]) + "「地煞针」"
    NOR
    "，$w飞蝗般打向$n全身",
            "dodge":        100,
            "force":        200,
...
mixed hit_ob(object me, object victim, int damage_bonus, int factor, string limb) {
    ...
    if (random(8) == 0 && level >= 300 && me->query_skill_mapped("force") == "biyun-xinfa") {
        ...
        return HIR
        "$N突然收掌，然后迅速发掌! 掌中尽然有毒砂，这掌风尽然是五颜六色的！$n硬起头皮，以掌硬接！！结果身中巨毒！!\n";
    }
...
int ob_hit(object ob, object me, int damage) {
    ...
    if (level2 > 100
        ...
        if (random(level) > 180
            ...
            "$n刚出玩招后，觉得身上的伤口一阵麻痒！但$n咬了咬牙关挺了过去。\n"
            NOR;
