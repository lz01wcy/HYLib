...
mapping *action = ({
    ([      "action" : "$N手中$w直劈，一招" + (mjj[random(13)]) + "「开门揖盗」"
    NOR
    "，挟着劲风万丈之式，向$n当头而下",
            "force" : 230,
            "dodge" : 10,
            "damage" : 100,
            "damage_type" : "割伤" ]),
    ([      "action" : "$N一招" + (mjj[random(13)]) + "「梅雪逢夏」"
    NOR
    "，卷起一片光幕，只见刀光漫天，向$n疾卷而去",
            "force" : 250,
            "dodge" : -10,
            "damage" : 150,
            "damage_type" : "割伤"
    ]),
    ([      "action" : "$N横刀直挥，一招" + (mjj[random(13)]) + "「汉将当关」"
    NOR
    "，刀身疾下,拢起一阵劲飙，向$n$l劈去",
            "force" : 280,
            "dodge" : 5,
    ...
    ([      "action" : "$N一招" + (mjj[random(13)]) + "「赤日金鼓」"
    NOR
    "，$w左右连劈六刀，一阵金芒自刀上疾射而出，映的$n\n双眼紧闭，$N乘机趋步上前,挥刀力斩$n$l",
            "force" : 300,
            "dodge" : 15,
            "damage" : 220,
            "damage_type" : "割伤"
    ]),
    ([      "action" : "$N手中$w一沉，一招" + (mjj[random(13)]) + "「千钧压驼」"
    NOR
    "，$w看似沉滞不堪,实则似缓实快，自下挽了一个刀花，\n直劈$n$l",
            "force" : 300,
            "dodge" : 5,
            "damage" : 250,
            "damage_type" : "割伤"
    ]),
    ([      "action" : "$N将$w往后一带，使出一招" + (mjj[random(13)]) + "「大海沉沙」"
    NOR
    "，$w顿时消失得无影无踪，$n正惊疑间，\n只见刀光一闪，$w已迅如闪电般斩往$l",
            "force" : 350,
            "dodge" : 15,
    ...
    ([      "action" : "$N一招" + (mjj[random(13)]) + "「鲍鱼之肆」"
    NOR
    "，挥舞$w狂劈十八刀，看似混乱不堪，实则刀刀劈向$n要害",
            "force" : 400,
            "dodge" : 15,
            "damage" : 350,
            "damage_type" : "劈伤"
    ]),
    ([      "action" : "$N踏步上前，使出" + (mjj[random(13)]) + "「赤日炎炎」"
    NOR
    "，手中$w倒提横挥，化成一簇簇烈焰，向$n劈头盖脸的斩去",
            "force" : 500,
            "dodge" : 10,
            "damage" : 500,
            "damage_type" : "刺伤"
...
//if (victim =me) return;
    ...
    if (random(level) > 100 && random(level3) > 100 && random(level2) > 100 && !me->query_temp("noauto")) {
        message_vision(WHT
        "$N一刀过后，招式突变，竞用刀使出了雪花剑法的招式攻向$n的周身要害！\n"
        NOR, me, victim );
        msg = HIR
        "看刀．．．．\n"
        NOR;
        ...
        return HIW
        "只见$n$l上鲜血渗出，六点刀痕布成六角，已被" + weapon->name() + HIW
        "整整齐齐的刺了六点。\n"
        NOR;
    }
...
int ob_hit(object ob, object me, int damage) {
    ...
    if (random(8) == 0 && level >= 300 && me->query_skill_mapped("force") == "bingxue-xinfa") {
        ...
        "$N"
        HIB
        "运起冰血心法!! 全身的伤口一瞬间止住了鲜血！\n"
        NOR;
        msg += HIB
        "一股寒气优似冰箭，循着手臂，迅速无伦的射入$n的胸膛\n"
        NOR;
