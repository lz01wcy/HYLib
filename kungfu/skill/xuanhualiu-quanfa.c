...
mapping *action = ({
    ([  "action" : "$N盘膝而坐，二手合十，一式" + (order[random(13)]) + "「翔」"
    NOR
    "，双拳蓄势而发，击向$n的$l",
            "force" : 180,
            "dodge" : 5,
    ...
    ([  "action" : "$N腾空飞起，一式" + (order[random(13)]) + "「息吹」"
    NOR
    "，双手双腿齐出，令$n无可躲藏",
            "force" : 230,
            "dodge" : 15,
    ...
    ([  "action" : "$N双掌虚含，掌缘下沉，一式" + (order[random(13)]) + "「无明」"
    NOR
    "，缓缓向$n推出",
            "force" : 200,
            "dodge" : 5,
    ...
    ([  "action" : "$N一臂前伸，一臂后指，一式" + (order[random(13)]) + "「无常」"
    NOR
    "，攻向$n的身前身后",
            "force" : 320,
            "dodge" : 10,
    ...
    ([  "action" : "$N两目内视，双手内笼，一式" + (order[random(13)]) + "「不动击」"
    NOR
    "，四面八方响起震人心魄的
    龙吟
    ",
    ...
    ([  "action" : "$N似笑非笑，双拳无形无定，一式" + (order[random(13)]) + "「影分生」"
    NOR
    "，骤然击向$n的前胸",
            "force" : 530,
            "dodge" : 20,
    ...
    (["action" :"$N双臂一挥，第一式" + (order[random(13)]) + "「影舞」"
    NOR
    "打出，以通臂之势，拳消力不消，劲风直逼$n而去",
            "force" : 150,
            "dodge" : 15,
            "damage": 215,
            "lvl" : 5,
    ...
    (["action" :"$N躬腰曲背，左臂一抡，架起一道气墙，接着右手握拳，对着$n，一招" + (order[random(13)]) + "「山岗」"
    NOR
    "穿墙而出",
            "force" : 200,
            "dodge" : 110,
    ...
    (["action" :"$N一个马步式" + (order[random(13)]) + "「龙椎旋」"
    NOR
    "，双拳凝力，跟着两臂相并，对准$n$l一式挥出，劲力异常",
            "force" : 220,
            "dodge" : 115,
            "damage": 115,
            "lvl" : 25,
    ...
    (["action" :"$N使出一招" + (order[random(13)]) + "「受流」"
    NOR
    "，双臂连连挥动，拳风伴着口中的狮子吼，如猛兽下山般袭向$n",
            "force" : 240,
            "dodge" : 120,
            "damage": 215,
            "lvl" : 45,
    ...
    (["action" :"$N单臂抡起一式" + (order[random(13)]) + "「直式」"
    NOR
    "打出，接着又是一拳相随，后浪推前浪，两波劲力合击$n",
            "force" : 260,
            "dodge" : 115,
            "damage": 215,
            "lvl" : 65,
    ...
    (["action" :"$N挥出数拳，正当$n质疑这花拳之势时，一股劲风爆出，正对$p胸口，是招虚实的" + (order[random(13)]) + "「必至」"
    NOR
    "",
            "force" : 280,
            "dodge" : 110,
    ...
    (["action" :"$N口颂佛经，打出一招" + (order[random(13)]) + "「斜式」"
    NOR
    "，直轰$n前胸，拳风至刚至阳，正大光明，不带丝毫阴气",
            "force" : 300,
            "dodge" : 115,
            "damage": 215,
            "lvl" : 85,
    ...
    (["action" :"只见$N合十而立，以这" + (order[random(13)]) + "「伏式」"
    NOR
    "一招为本，以身为拳，劲力布满全身，重重压向$n",
            "force" : 450,
            "dodge" : 115,
            "damage": 215,
            "lvl" : 105,
...
mixed hit_ob(object me, object victim, int damage_bonus, int factor) {
    ...
    if (me->query_skill_mapped("force") == "shayi-xinfa" && lvl > 300 && random(8) == 0) {
        ...
        NOR;
        if (random(3) == 0) msg = HIR
        "「隔空击物!」。$N将二重劲的威力传至远方攻击的$n,用以弥补远距离攻击的不足 。\n"
        NOR;
        if (random(3) == 1) msg = HIR
        "「喷射火焰!」。$N胃装油袋,用火石制的假牙点火喷出火焰,$n被极大的火焰打中!! \n"
        NOR;
        if (random(3) == 2) msg = HIR
        "「仙鹤飞腿!」。$N使出丑鬼直接传授的拳法之一踢向$n! 这踢法已独创一格!!\n"
        NOR;
