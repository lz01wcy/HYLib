...
mapping *action = ({
    ...
    ([    "skill_name" :"来鹤清泉",
            "action": "$N突然腰一弯，挺$w向$n刺去，这一剑力劲剑疾，正是一招"
    HIC
    "「来鹤清泉」"
    NOR
    "",
    ...
    ([    "name":    "石关回马",
            "action":  "$N手中$w刷的一声，反手砍向$n，剑势圆润如意："
    HIY
    "「石关回马」"
    NOR
    "！",
    ...
    ([    "skill_name" : "泰山十八盘",
            "action":  "$N展开剑势，身随剑走，左边一拐，右边一弯，越转越急。猛地$w剑光暴长，一招"
    HIM
    "「泰山十八盘」"
    NOR
    "往$n$l刺去",
    ...
    ([    "skill_name" :"快活三里",
            "action": "$N手臂暴长，手中$w豁豁展开，刷刷两剑，指向$n，正是"
    GRN
    "「快活三里」"
    NOR
    "",
    ...
    "「七星落长空」"
    NOR
    "挺$w向$n当胸刺去，剑光闪烁，$w发出嗡嗡之声，罩住了$n胸口“膻中”、“神藏”、“灵墟”、“神封”、“步廊”、“幽门”、“通谷”七处大穴",
            "lvl" : 60
    ]),
    ([    "skill_name" :"五大夫剑",
            "action":  "$N手中$w倏地刺出，一连五剑，每一剑的剑招皆苍然有古意。招数古朴，内藏奇变，正是"
    HIW
    "「五大夫剑」"
    NOR
    "",
...
/* d_e=dodge_effect p_e=parry_effect f_e=force_effect m_e=damage_effect */
    ...
    if (me->query_temp("ruhe_count") > 15 || me->query_temp("ruhe_hit")) {
        ...
        "action":HIY
        "$N左手计算已毕，$w" + HIY
        "出招，正是泰山派剑法中最高深的绝艺「岱宗如何」，这一剑算准了$n的一切应变後着，实是威力无俦，博大精深"
        NOR,
                "force" : 450 + random(20),
                "dodge" : 70,
                "parry" : 70,
        ...
        "action":YEL
        "$N$w" + YEL
        "倏地向$n刺出，连连出剑，每一剑的剑招皆苍然有古意，招数古朴，内藏奇变，正是「五大夫剑」"
        NOR,
                "force" : 400 + random(55),
                "dodge" : 10,
                "parry" : 15,
        ...
        "action":HIC
        "$N陡然向$n连环三剑，$w" + HIC
        "使得犹似行云流水，大有善御者驾轻车而行熟路之意，将「快活三」剑招发挥得淋漓尽致"
        NOR,
                "force" : 333 + random(33),
                "dodge" : 10,
                "parry" : 15,
...
int ruhe(object me, object victim, object weapon, int damage) {
    ...
    msg = ({
        CYN
        "不料$N左手屈指连算，已算准了$n的腾挪方位，又即挺剑出招！\n"
        NOR,
                CYN
        "但是$n的武功门路已被$N算得清清楚楚，眼见已避开$N的招数，" + weapon->name() + CYN
        "竟又直逼而至！\n"
        NOR,
    });
    if (!victim) return 0;
