...
mapping *action = ({
    ([    "action":"\n$N手中$w一抖，一式" + (order[random(13)]) + "「灵蛇吐信」"
    NOR
    "，闪电般的疾刺向$n的$l",
            "force" : 160,
            "dodge" : 5,
    ...
    ([    "action":"\n$N一式" + (order[random(13)]) + "「柔丝轻系」"
    NOR
    "，剑意绵绵不绝，化做一张无形的大网将$n困在当中",
            "force" : 240,
            "dodge" : 10,
            "damage": 325,
            "lvl" : 10,
    ...
    ([    "action":"\n$N一声阴笑，飞身纵起，一式" + (order[random(13)]) + "「张牙舞爪」"
    NOR
    "，手中$w狂舞，幻出千万条\n手臂，合身扑向$n",
            "force" : 380,
            "dodge" : 15,
    ...
    ([    "action":"$N脚步踉跄，身形忽的向前跌倒，一式" + (order[random(13)]) + "「井底望月」"
    NOR
    ...
    ([    "action":"$N身形一晃，一式" + (order[random(13)]) + "「金蛇缠腕」"
    NOR
    "，手中$w如附骨之蛆般无声无息地刺向$n\n的手腕",
            "force" : 680,
            "dodge" : 70,
    ...
    ([    "action":"\n$N一声厉啸，身形冲天而起，一式" + (order[random(13)]) + "「神蟾九变」"
    NOR
    "，掌中$w如鬼魅般连刺\n$n全身九道大穴",
            "force" : 450,
            "dodge" : 80,
    ...
    ([    "action":"$N深吸一口起，双手握钩，招演" + (order[random(13)]) + "「万毒至尊」"
    NOR
    "，$w尖端透出一条强劲的黑\n气，闪电般的袭向$n",
            "force" : 780,
            "dodge" : 45,
