...
int perform(object me, object target) {
    ...
    msg = HIW
    "$N脸色凝重，手中宝剑寒气逼人，剑气撕裂空气，周围忽起阵阵杀机，温度骤降，片片雪花飘落，剑未至气先及，$n如堕冰窖，眉毛都蒙上了薄薄白霜！只见$N一声怒嚎,“千里冰封”，冰气剑茫挟着漫天风雪，以雷霆之势扑向$n,天地为之变色！" +
    "\n" + NOR;
    ...
    if (ap / 2 + random(ap * 2) > dp) {
        ...
        me->add("neili", -150);
        msg += HIM
        "$n已然冻僵，哪能闪避，$N的寒气剑茫顿时透体而入，口中鲜血狂喷，连退数步。" + "\n"
        NOR;
        ...
        msg += NOR + CYN
        "$p见势不妙，顾不上脸面，连着几个懒驴打滚，狼狈之至，险险避过$P的这记杀招，尘土飞扬中，地上裂开了一道大口子！" + "\n"
        NOR;
        me->add("neili", -100);
    }
