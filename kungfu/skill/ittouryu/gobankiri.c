...
int perform(object me, object target) {
    ...
    if (random(hisexp * 5) < (extra * extra * extra / 4 + myexp + hisexp) / 3 && weapon) {
        message_vision(
                HIG
        "$N根本无视$n的攻击，大吼一声「棋盘切」！将" + weapon_name + "高举过肩，自右上方直向$n劈来。面对$N的雷霆一般的一击，$n用手中的兵器下意识地一挡。" + HIW
        ...
        msg = HIG
        "$N根本无视$n的攻击，大吼一声「棋盘切」！将" + weapon_name + "高举过肩，自右上方直向$n劈来。面对$N的雷霆一般的一击，$n用手中的兵器下意识地一挡。" + HIC
        ...
        msg = HIG
        "$N根本无视$n的攻击，大吼一声「棋盘切」！将$w高举过肩，自右上方直向$n劈来。"
        NOR;
