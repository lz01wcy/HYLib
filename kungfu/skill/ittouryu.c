...
mapping query_action(object me, object weapon) {
    ...
    if (random(2) == 1 && random(level) > 180) {
        return ([
        "action": RED
        "" + (order[random(13)]) + "「  牙突一式! 」"
        NOR
        "" + HIY
        "$N突然加速！刺出后水平横扫,追击躲闪的$n!"
        NOR,
    ...
    if (random(2) == 1 && random(level) > 190) {
        return ([
        "action": HIR
        "" + (order[random(13)]) + "「  牙突二式! 」"
        NOR
        "" + HIY
        "$N突然加速！刀举头上,刺出后向$n运动劈下! "
        NOR,
                "force" : 650 + random(200),
                "attack" : 50,
                "dodge" : 70,
    ...
    if (random(2) == 1 && random(level) > 200) {
        return ([
        "action": HIM
        "" + (order[random(13)]) + "「  牙突三式! 」"
        NOR
        "" + HIY
        "$N突然加速！由下刺上,对跃起的$n使出牙突,这是是对空的招式！"
        NOR,
                "force" : 650 + random(200),
                "attack" : 90,
                "dodge" : 50,
    ...
    if (random(2) == 1 && random(level) > 240) {
        return ([
        "action": HIW
        "" + (order[random(13)]) + "「  牙突零式! 」"
        NOR
        "" + HIY
        "$N在离$n极近距离猛的将刀刺出,威力巨大,这乃是一招必杀技 ！"
        NOR,
                "force" : 650 + random(200),
                "attack" : 120,
                "dodge" : 50,
...
mixed hit_ob(object me, object victim, int damage_bonus, int factor, string limb) {
    ...
    if (me->query_skill_mapped("force") == "shayi-xinfa" && lvl > 300 && random(8) == 0) {
        ...
        "$N御技如神，杀气冲天！\n"
        NOR;
        if (random(5) == 0) msg = HIC
        "「百鬼冲！！」" + HIY
        "$N御技如神，杀气冲天！。\n"
        NOR;
        if (random(5) == 1) msg = HIM
        "「百鬼碎！！」" + HIY
        "$N御技如神，杀气冲天！ \n"
        NOR;
        ...
        "$N御技如神，杀气冲天！\n"
        NOR;
        if (random(5) == 3) msg = HIG
        "「百鬼坠！！」" + HIW
        "$N御技如神，杀气冲天！\n"
        NOR;
        if (random(5) == 4) msg = HIW
        "「百鬼斩！！」" + HIY
        "$N御技如神，杀气冲天！ \n"
        NOR;
