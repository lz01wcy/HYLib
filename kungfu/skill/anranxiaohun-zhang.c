...
mapping *action = ({
    ([      "action": "" + (order[random(13)]) + "$N单臂负后，凝目远眺，脚下虚浮，胸前门户洞开，全身姿势与武学中各项大忌无不吻合。$n略一迟疑，浑身已为$N掌力所绕"
    NOR
    "",
            "dodge": 30,
            "force": 400,
    ...
    ([      "action": "$N一招" + (order[random(13)]) + "「心惊肉跳」"
    NOR
    "，小腹肌肉颤动，同时胸口向内收缩，倏地弹出迎向$n的双拳",
            "dodge": 15,
            "force": 380,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
            "damage" : (int) this_player()->query("age") * 8,
    ...
    ([    "action": "$N一式" + (order[random(13)]) + "「杞人忧天」"
    NOR
    "，抬头向天，对$n的招数浑若不见，呼的一掌向自己头顶空空拍出，手掌斜下，掌力化成弧形，四散落下拢住$n全身",
            "dodge": 10,
            "force": 320,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
            "damage" : (int) this_player()->query("age") * 8,
    ...
    ([    "action": "$N突然手足齐动，一式" + (order[random(13)]) + "「无中生有」"
    NOR
    "左掌右袖，双足头锤，连的胸背腰腹尽皆有招式攻出，无一不足以伤人",
            "dodge": 15,
            "force": 160,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
            "damage" : (int) this_player()->query("age") * 8,
    ...
    ([    "action": "$N一式" + (order[random(13)]) + "「拖泥带水」"
    NOR
    "，右手云袖飘动，宛若流水，左掌却重滞之极，便似带着几千斤泥沙一般，暗藏五行杀机，直罩$n的$l",
            "dodge": 30,
            "force": 230,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
            "damage" : (int) this_player()->query("age") * 8,
    ...
    ([    "action": "$N身影陡转，如鬼魅般忽前忽后，瞬左瞬右，一式" + (order[random(13)]) + "「徘徊空谷」"
    NOR
    "掌风已至$n的$l",
            "dodge": 10,
            "force": 250,
    ...
    ([    "action": "$N长叹一声，沧桑疲惫，身形凝重，却是一招" + (order[random(13)]) + "「力不从心」"
    NOR
    "，诱得$n全力进击之际，反手直拍命门大穴",
            "dodge": 10,
            "force": 100,
    ...
    ([    "action": "$N面目僵然，四肢挺直，无弯无折，便似" + (order[random(13)]) + "「行尸走肉」"
    NOR
    "般，刀臂剑腿，横斩直刺$n的$l",
            "dodge": 25,
            "force": 500,
    ...
    ([    "action": "$N一式" + (order[random(13)]) + "「庸人自扰」"
    NOR
    "，左手锤胸，一边晃首不止，身形却也在倏忽间绕敌身后，右掌闪电般暴击$n的后心",
            "dodge": 20,
            "force": 430,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
            "damage" : (int) this_player()->query("age") * 8,
    ...
    ([    "action": "" + (order[random(13)]) + "$N突然头下脚上，倒过身子，口中嗬嗬而叫，手代足行，足似手攻，双足狂踢未定，双手互又闪电般拍向$n的下盘"
    NOR
    "",
            "dodge": 10,
            "force": 360,
    ...
    ([    "action": "" + (order[random(13)]) + "$N忽然狂笑不止，忽又颠哭阵阵，嬉笑哀啼，$n不由心神驿动，正迷沉恍惚中$N已一腿攻向$n的$l"
    NOR
    "",
            "dodge": 20,
            "force": 400,
    ...
    ([    "action": "" + (order[random(13)]) + "却见$N翻身坐倒，双手合十，默颂经文，旋及人似车轮般旋向空中，凭空砸向$n,威力骇人，无法硬接"
    NOR
    "",
            "dodge": 20,
            "force": 450,
    ...
    "杞人忧天"
    NOR
    "抬头向天，浑若不见，呼的一掌向自己头顶空空拍出，手掌斜下，掌力化成弧形，四散落下拍向$n的$l。",
            "force" : 250,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
            "dodge" : 120,
            "damage" : (int) this_player()->query("age") * 8,
    ...
    "无中生有"
    NOR
    "手臂下垂，绝无半点防御姿式，突然间手足齐动，左掌右袖、双足头锤、连得胸背腰腹尽皆有招式发出撞向$n.",
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
            "dodge" : 100,
            "force" : 250,
            "damage" : (int) this_player()->query("age") * 8,
    ...
    "拖泥带水"
    NOR
    "右手云袖飘动，宛若流水，左掌却重滞之极，便似带着几千斤泥沙一般，左右齐攻$n。",
            "force" : 250,
            "dodge" : 100,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
            "damage" : (int) this_player()->query("age") * 8,
    ...
    "力不从心"
    NOR
    "含胸收腹，头缓缓低下，脚步沉重的迈向$n,右掌软绵绵的拍向$n的$l。",
            "force" : 300,
            "damage" : (int) this_player()->query("age") * 8,
            "dodge" : 100,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
    ...
    "行尸走肉"
    NOR
    "踢出一脚。这一脚发出时恍恍惚惚，隐隐约约，若有若无的踢向$n",
            "force" : 250,
            "damage" : (int) this_player()->query("age") * 8,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
            "dodge" : 100,
    ...
    "心惊肉跳"
    NOR
    "凝目远眺，脚下虚浮，胸前门户洞开，全身姿式与武学中各项大忌无不吻合。",
            "force" : 300,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
            "dodge" : 120,
    ...
    "废寝忘食"
    NOR
    "脚下虚浮，有如几天不吃不睡后的脚步朗舱的袭到$n的身旁，左掌右拳攻向$n的$l。",
            "force" : 300,
            "dodge" : 120,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
    ...
    "六神不安"
    NOR
    "身如陀螺急转，展开轻功围着$n快速游走，忽然飞身而起，拍向$n的$l。",
            "force" : 400,
            "dodge" : 120,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
    ...
    "穷途末路"
    NOR
    "闪身到$n身旁，左掌举到胸前平推而出，接着右掌斜斜劈向$n的$l。",
            "force" : 450,
            "dodge" : 120,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
    ...
    "鹿死谁手"
    NOR
    "招招抢先，以快打慢，一个转身已经转到了$n的身后，运指如风点向$n的大椎穴。",
            "force" : 600,
            "dodge" : 160,
            "attack":this_player()->query_skill("anranxiaohun-zhang", 1),
...
//            target = offensive_target(me);    
            switch (random(3)) {
                case 0:
                    msg = HIC
                    "$N心下万念俱灰，没精打采的挥袖卷出，拍出一掌，只听得噗的一声，这一掌正好击向$n肩头"
                    NOR;
                    break;
                case 1:
                    msg = HIY
                ...
                case 2:
                    msg = HIR
                    "紧跟着$N踢出一脚。这一脚发出时恍恍惚惚，隐隐约约，若有若无。砰的一响，向$n胸口袭去"
                    NOR;
                    break;
                default:
                    msg = HIC
...
mixed hit_ob(object me, object victim, int damage_bonus) {
    ...
    if (!random(8) && !victim->is_busy() && j > 140
        ...
        switch (random(3)) {
            case 0 :
                msg = YEL
                "$N抬头向天，浑若不见，呼的一掌向头顶空空拍出，手掌斜下，掌力化成弧形，四散落下！\n"
                NOR;
                msg += HIR
                "结果$n被这一招「杞人忧天」带得别说挣扎，竟连站定脚步也是不能。\n"
                NOR;
                if (!victim->is_busy())victim->start_busy(4);
                break;
            case 1 :
                msg = HIB
                "$N右手云袖飘动，宛若流水，左掌却重滞之极，便似带着几千斤泥沙一般！\n"
                NOR;
                msg += HIR
                "结果$n被这一招「拖泥带水」带得犹如身陷洪涛巨浪，跌跌撞撞。\n"
                NOR;
                if (!victim->is_busy())victim->start_busy(4);
                break;
            case 2 :
                msg = HIG
                "突然间$N手足齐动，左掌右袖、双足头锤、连得胸背腰腹尽皆有招式发出！\n"
                NOR;
                msg += HIR
                "结果$n被这一招「无中生有」带得自身全然身不由主的境地。\n"
                NOR;
                if (!victim->is_busy())victim->start_busy(4);
                break;
        }
    ...
    if (damage_bonus / 2 > victim->query_str()) {
        if ((int) me->query_skill("yunv-xinfa", 1) > 10 || random(10) > 5
            ...
            if (me->query_skill_mapped("unarmed") == "anranxiaohun-zhang") {
                ...
                return HIR
                "只听到“哇”的一声，" + victim->name() + "喷出了一大口鲜血！\n"
                NOR;
            }
        }
    }
...
int ob_hit(object ob, object me, int damage) {
    ...
    if (random(8) == 0 && level2 >= 300 && (me->query_skill_mapped("force") == "yunv-xinfa")) {
        ...
        msg = HIC
        "$N" + HIC + "满场游走，招断意连，绵绵不绝，一招未毕，二招至 !$n双眼一花不知所措！\n" + NOR;
        if (random(2) == 0) {
            msg += HIY
            "$N" + HIY + "目光一闪，一把玉锋针扔出 !$n 一不当心，身上连中了几枚！\n" + NOR;
