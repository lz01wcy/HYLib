...
void create()
{
	...
	"便把你的心灵，推向梦中极美的境界。\n" NOR);
 	...
 	set("age", 18);
        ...
        set("chat_chance", 10);
        set("chat_msg", ({
		(: command, "es 202.101.10.187 5555 上海海洋II总站，80种任务，多种特殊系统" :),
...
"小龙女把头一挥，满头乌发随风飘荡，如仙女下凡一般。\n",
		...
		(: command, "sleep hxsd" :),
                (: command, "kiss hxsd" :),
		(: command, "es 202.101.10.187 5555 上海海洋II总站，欢迎您的到来" :),
    	        (: command, "es 202.101.10.187 5555 80种任务，多种特殊系统,上海海洋II总站，欢迎您的到来" :),
                (:random_chat:),
        }) );
	set("chat_chance_combat", 90);  
        set("chat_msg_combat", ({
